...
const MainCard = ({ title, content, image }) => {
  let baseStyle =
    "flex flex-col justify-center items-center bg-[#fe7867]/[.02] px-16 lg:px-24";
  let linkStyle =
    "relative px-2 md:self-start font-fraunces lg:text-2xl text-xl text-[#23303e] font-bold after:bg-red-200 row__link";
  return (
